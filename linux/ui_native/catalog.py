...
def build_catalog(root: Path, platform_name: str | None = None) -> list[ActionSpec]:
    ...
    actions.extend(
        [
            ...
            _a("windows.provision.plan", "Windows VM", "Planejar instalação automática", "Gera plano completo de instalação e otimização.", ("windows-vm", "provision", "plan", "--iso", "{input}", "--json"), "document-properties", input_label="Selecione ISO do Windows", input_kind="file", badge="Seguro"),
