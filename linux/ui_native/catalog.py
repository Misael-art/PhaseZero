...
def build_catalog(root: Path, platform_name: str | None = None) -> list[ActionSpec]:
    ...
    actions.extend(
        [
            ...
            _a("ai.9router.watchdog-install", "IA & Dev", "Ativar watchdog 9Router", "Testa providers e coleta telemetria a cada minuto.", ("ai", "9router", "watchdog", "install"), "appointment-new", mutable=True, preview=("ai", "9router", "status"), visibility="advanced"),
            ...
            _a("ai.proxies.install-one", "IA & Dev", "Instalar proxy específico", "Instala ou atualiza um proxy da suite.", ("ai", "proxies", "install", "{proxy}"), "network-server", mutable=True, preview=("ai", "proxies", "status"), parameters=(_p("proxy", "Proxy", "choice", choices=("all", "kimiproxy", "qwenproxy", "deepsproxy", "9router")),), visibility="advanced"),
