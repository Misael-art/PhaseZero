...
def build_catalog(root: Path, platform_name: str | None = None) -> list[ActionSpec]:
    ...
    ai_rows = [
        ...
        ("odysseus-update", "Atualizar Odysseus (protegido)", "Exige novo commit na allowlist e release gate; caso contrário, somente planeja.", ("ai", "odysseus", "update"), ("ai", "odysseus", "plan")),
        ...
        ("workspaces-doctor", "Diagnóstico Hermes + Odysseus", "Auditoria profunda, read-only e redigida de toda a jornada.", ("ai", "workspaces", "doctor"), None),
        ("workspaces-plan", "Plano Hermes + Odysseus", "Mostra fases, blockers e próxima ação segura sem implantar workloads.", ("ai", "workspaces", "plan"), None),
