...
@pytest.mark.parametrize(
    ...
    [
        ...
        (("ai", "proxies"), ("status", "detailed-status", "install", "configure-ides", "auth", "login", "test", "start", "stop", "restart")),
        (("ai", "9router"), ("status", "install", "dashboard", "test", "provider", "combo", "usage", "client", "check-update", "update", "doctor")),
        (("ai", "odysseus"), ("status", "install", "open", "check-update", "update", "backup", "doctor")),
        (("updates",), ("check", "install-service")),
