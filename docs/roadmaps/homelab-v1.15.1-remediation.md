...
| Jornada Windows/integrações | branch `codex/ui-windows-install-journey`; ISO antecipada, índices 1–10, player modal e controles reversíveis Windows/Waydroid/Servidor implementados; sem push/release/install | pytest 436 + 9; provision 228/0; `linux-windows-vm.sh` e `linux-waydroid.sh` exit 0; QA offscreen | 2026-08-09 |
